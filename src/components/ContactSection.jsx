...
import { Phone, Mail, MapPin, CheckCircle, FacebookIcon } from "lucide-react";
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300">
            Ready to start your exciting academic journey?
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4">
                  ...
                  <span className="text-gray-700 dark:text-gray-300">
                    +91 8092246952/ +91 8699499195
                  </span>
                </div>
                <div className="flex items-center space-x-4">
                  <Mail className="w-6 h-6 text-blue-600" />
                  <span className="text-gray-700 dark:text-gray-300">
                    <a href="mailto:sharmabishwajit93@gmail.com">
                      sphyclasses@gmail.com
                    </a>
                  </span>
                </div>
                <div className="flex items-center space-x-4">
                  <FaFacebook className="w-6 h-6 text-blue-600" />
                  <a href="https://www.facebook.com/share/1AzS3UnKVU/" 
                  target="__blank"
                ...
                <div className="flex items-center space-x-4">
                  ...
                  href="https://www.instagram.com/s_phy_classes"
                  target="__blank"
                  >
                    Sphy-classes
                  </a>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <span className="text-gray-700 dark:text-gray-300">
                    Opposite Delhi Public School, Karmik Nagar, Dhanbad
                    Jharkhand, India
                  </span>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-blue-50 dark:from-gray-700 dark:to-gray-600 p-8 rounded-2xl">
              ...
              <ul className="space-y-3">
                <li className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-700 dark:text-gray-300">
                    Expert guidance from IIT Alumni
                  </span>
                </li>
                <li className="flex items-center space-x-3">
                  <CheckCircle className="w-5 h-5 text-green-500" />
          ...
          <div className="bg-gray-50 dark:bg-gray-700 p-8 rounded-2xl">
            ...
            <p className="mb-5  font-semibold text-red-500">
              We will be available soon with contact feature. Use Email or
              Contact Number.{" "}
            </p>
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                >
                  ...
                  <option value="IIT-JEE Preparation">
                    IIT-JEE Preparation
                  </option>
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-gray-600 to-blue-600
